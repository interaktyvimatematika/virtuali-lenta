(() => {
  ...
  // P1.7.9.49-M2.7: kameros matematika lieka board-camera.js, tinklelio
  ...
  // teksto / formulės objekto DOM redagavimo valdymas board-text-editor.js, o
  // MathLive laukų įvedimo / LaTeX / vektorių branduolys board-math-field.js.
  ...
  // P1.7.9.49-M2.7: MathLive lauko įvedimo / LaTeX / vektorių branduolys
  // iškeltas į board-math-field.js. Matematikos juostos kategorijos ir jos
  // mygtukų semantika sąmoningai lieka šiame faile.
